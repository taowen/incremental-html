...
Render in server side, using html as "virtual DOM" to update ui incrementally. The goal is to quickly prototype a web application without compromising user experience.
...
common pan gesture interactions
