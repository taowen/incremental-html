...
const int = __spreadProps(__spreadValues({}, styleValueTypes.number), {
...
function mixValues(target, follow, lead, progress, shouldCrossfadeOpacity, isOnlyMember) {
  ...
  if (shouldCrossfadeOpacity) {
    target.opacity = popmotion.mix(0, (_a = lead.opacity) != null ? _a : 1, easeCrossfadeIn(progress));
    target.opacityExit = popmotion.mix((_b = follow.opacity) != null ? _b : 1, 0, easeCrossfadeOut(progress));
  } else if (isOnlyMember) {
    target.opacity = popmotion.mix((_c = follow.opacity) != null ? _c : 1, (_d = lead.opacity) != null ? _d : 1, progress);
  }
